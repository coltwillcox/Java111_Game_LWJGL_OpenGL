...
public class ParticleRenderer {
    ...
    private void updateTexCoordInfo(Particle particle, float[] data) {
        data[pointer++] = particle.getTexOffset1().getX();
        data[pointer++] = particle.getTexOffset1().getY();
        data[pointer++] = particle.getTexOffset2().getX();
        data[pointer++] = particle.getTexOffset2().getY();
