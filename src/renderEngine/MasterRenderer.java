...
public class MasterRenderer {
    ...
    private static final float RED = (float) 80/255; //Easy to use with color pickers.
    private static final float GREEN = (float) 100/255;
    private static final float BLUE = (float) 100/255;
