    ...
    public static RawModel loadObjModel (String fileName, Loader loader) {
        ...
        try {
            while (true) {
                ...
                String[] currentLine = line.split(" "); //Split line and make array where elements are words between spaces.
            ...
            while (line != null) {
                ...
                String[] currentLine = line.split(" "); //Example: f 41/1/1 38/2/1 45/3/1
                String[] vertex1 = currentLine[1].split("/"); //41/1/1
                String[] vertex2 = currentLine[2].split("/"); //38/2/1
                String[] vertex3 = currentLine[3].split("/"); //45/3/1
