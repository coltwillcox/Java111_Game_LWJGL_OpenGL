...
/**
 * The frame buffer for the shadow pass. This class sets up the depth texture which can be rendered to during the shadow
 * render pass, producing a shadow map.
 */
