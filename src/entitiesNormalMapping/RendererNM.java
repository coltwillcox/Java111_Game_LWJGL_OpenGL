...
public class RendererNM {

	private ShaderNM shader;

	//Constructor.
    public RendererNM(Matrix4f projectionMatrix) {
		this.shader = new ShaderNM();
		shader.start();
	...
	private void prepareTexturedModel(TexturedModel model) {
        ...
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, model.getTexture().getMapNormal());
	}
